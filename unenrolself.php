...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'sber'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/sber/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_sber', format_string($course->fullname));
